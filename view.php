...
<div class="container" style="margin-top:30px">
  ...
  <!--left side -->
      ...
      <h4>All Customer Details Here..</h4>
      </div>
      
      <div class="quick_menu">
         <i class="icon-list"></i> List Of All Customer
         <div style="padding:10px;"><input type="text" id="search" placeholder="Search by Unique ID" style="width:420px; height:30px; border:1px solid #414141"></div>
         <div class="tab">
...
?>
    ...
    <td><a class="btn btn-success" href="user.php?id=<?php echo $row['user_id']; ?>"><i class="icon-refresh icon-white"></i> View</a>
    <a class="btn btn-warning" href="update.php?id=<?php echo $row['user_id']; ?>"><i class="icon-text-width icon-white"></i> edit</a>
    </td>
  </tr>
